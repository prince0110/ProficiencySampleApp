...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Proficiency_iOS",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC15Proficiency_iOS11AppDelegate") SWIFT_AVAILABILITY(ios,introduced=13.0) SWIFT_AVAILABILITY(ios,introduced=13.0) SWIFT_AVAILABILITY(ios,introduced=13.0) SWIFT_AVAILABILITY(ios,introduced=13.0) SWIFT_AVAILABILITY(ios,introduced=13.0)
...
SWIFT_CLASS("_TtC15Proficiency_iOS13SceneDelegate") SWIFT_AVAILABILITY(ios,introduced=13.0)
